...
//     //callback function like next
//     cb(null, 'public/img/users');
//   },
//   filename: (req, file, cb) => {
//     //user--fklasdjfjsdofj--34324324.jpeg ==> user-id-timestamp
...
//assigning a current user in url little trick
...
exports.updateMe = catchAsync(async (req, res, next) => {
  ...
  // 2) filter out fields which are allowed
